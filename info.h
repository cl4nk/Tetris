...
typedef enum GameSkins {
	CLASSIC_SKIN, BLACK_SKIN, MARIO_SKIN, DB_SKIN, HOLO_SKIN, UNICORN_SKIN, NBR_SKINS
} GameSkins;

typedef enum GameModes {
	CLASSIC_MODE, BLOCK_MODE, BELOW_MODE, STRANGE_MODE, NBR_MODES
} GameModes;

typedef enum TypeBonus {
	NO_BONUS, CELL_BONUS, BLOCK_BONUS, LINE_BONUS, NBR_BONUS
} TypeBonus;
